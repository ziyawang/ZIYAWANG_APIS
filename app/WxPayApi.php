 ...
 *
 */
class WeChat extends WxPayDataBase
{ 
  /**
  * 设置微信分配的公众账号ID
  * @param string $value 
...
class WxPayConfig
{
   ...
   * @var string
   */
  const APPID = 'wx0c117367aa543268';
  const MCHID = '1389032102';
  const KEY = 'WkaIEottaw0wHODpOqyEMFxHrmz4LPjZ';
  const APPSECRET = '693499fa7a4266c57440bf76c896014d';
